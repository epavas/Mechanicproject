        ...
        <div class="contenedor">
            <div style="margin: 0px auto; box-shadow: 0 0 20px 0 rgba(0, 0, 0, 0.2), 0 5px 5px 0 rgba(0, 0, 0, 0.24); margin-top: 30px; background-color: white;">
                <div style="padding-top: 40px; padding-bottom: 40px; padding-left: 40px; padding-right: 40px;">
                    ...
                    <br />
                    <br />
                    <asp:TextBox ID="TextBox2" placeholder="Contraseña" TextMode="Password" runat="server" Height="30px" Width="240px"></asp:TextBox>
                    <br />
                    <br />
                    <asp:Button CssClass="btn" ID="Button1" runat="server" Text="Iniciar Sesión" Font-Names="Berlin Sans FB" Font-Size="Larger" ForeColor="#190000" Height="40px" Width="140px" OnClick="Button1_Click" /><br />
                    <asp:LinkButton CssClass="reg" ID="LinkButton1" runat="server" OnClick="LinkButton1_Click">Registrarse</asp:LinkButton>
                </div>
